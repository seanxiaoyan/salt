...
def installed(name, target='LocalSystem', dmg=False, store=False, app=False, mpkg=False, force=False, allow_untrusted=False, version_check=None):
    log.info('Trace')
    ...
    if version_check is not None:
        ...
        if len(split) == 2:
            ...
            if re.match(expected_version, version_out) is not None:
                ...
                ret['comment'] += "Version {} doesn't match {}. ".format(version_out, expected_version)
