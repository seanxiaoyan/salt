...
def present(name, value, hostid=None, **kwargs):
    ...
    if hostid:
        ...
        comment_usermacro_notcreated = 'Unable to create usermacro: {} on hostid {}. '.format(name, hostid)
        comment_usermacro_exists = 'Usermacro {} already exists on hostid {}.'.format(name, hostid)
        changes_usermacro_created = {name: {'old': 'Usermacro {} does not exist on hostid {}.'.format(name, hostid), 'new': 'Usermacro {} created on hostid {}.'.format(name, hostid)}}
    else:
        ...
        changes_usermacro_created = {name: {'old': 'Usermacro {} does not exist.'.format(name), 'new': 'Usermacro {} created.'.format(name)}}
...
def absent(name, hostid=None, **kwargs):
    ...
    if hostid:
        ...
        comment_usermacro_notdeleted = 'Unable to delete usermacro: {} from hostid {}.'.format(name, hostid)
        comment_usermacro_notexists = 'Usermacro {} does not exist on hostid {}.'.format(name, hostid)
        changes_usermacro_deleted = {name: {'old': 'Usermacro {} exists on hostid {}.'.format(name, hostid), 'new': 'Usermacro {} deleted from {}.'.format(name, hostid)}}
    else:
        ...
        changes_usermacro_deleted = {name: {'old': 'Usermacro {} exists.'.format(name), 'new': 'Usermacro {} deleted.'.format(name)}}
    if hostid:
        usermacro_exists = __salt__['zabbix.usermacro_get'](name, hostids=hostid, **connection_args)
    else:
        usermacro_exists = __salt__['zabbix.usermacro_get'](name, globalmacro=True, **connection_args)
