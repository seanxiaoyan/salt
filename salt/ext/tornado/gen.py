...
try:
    try:
        ...
        from salt.ext.backports_abc import Generator as GeneratorType
    try:
            ...
            if isinstance(result, GeneratorType):
                try:
                    ...
                    if stack_context._state.contexts is not orig_stack_contexts:
                        ...
                        yielded.set_exception(stack_context.StackContextInconsistentError('stack_context inconsistency (probably caused by yield within a "with StackContext" block)'))
...
class MultiYieldPoint(YieldPoint):
    ...
    def is_ready(self):
        finished = list(itertools.takewhile(lambda i: i.is_ready(), self.unfinished_children))
    ...
    def get_result(self):
        ...
        for f in self.children:
            try:
                ...
                elif not isinstance(e, self.quiet_exceptions):
...
class Runner(object):
    ...
    def result_callback(self, key):
        return stack_context.wrap(_argument_adapter(functools.partial(self.set_result, key)))
