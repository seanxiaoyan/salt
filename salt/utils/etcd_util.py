...
class EtcdClient(EtcdBase):
    ...
    def watch(self, key, recurse=False, timeout=0, start_revision=None, **kwargs):
        ...
        if index is not None:
            salt.utils.versions.warn_until('Argon', 'The index kwarg has been deprecated, and will be removed in the Argon release. Please use start_revision instead.')
    ...
    def read(self, key, recurse=False, wait=False, timeout=None, start_revision=None, **kwargs):
        ...
        if recursive is not None:
            salt.utils.versions.warn_until('Argon', 'The recursive kwarg has been deprecated, and will be removed in the Argon release. Please use recurse instead.')
            recurse = recursive
        if wait_index is not None:
            salt.utils.versions.warn_until('Argon', 'The waitIndex kwarg has been deprecated, and will be removed in the Argon release. Please use start_revision instead.')
...
def get_conn(opts, profile=None, **kwargs):
    ...
    if use_v2:
        salt.utils.versions.warn_until('Potassium', 'etcd API v2 has been deprecated.  It will be removed in the Potassium release, and etcd API v3 will be the default.')
