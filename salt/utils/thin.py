...
def get_tops_python(py_ver, exclude=None, ext_py_ver=None):
    ...
    """
    files = {}
    mods = ['jinja2', 'yaml', 'tornado', 'msgpack', 'certifi', 'singledispatch', 'concurrent', 'singledispatch_helpers', 'ssl_match_hostname', 'markupsafe', 'backports_abc']
...
def get_tops(extra_mods='', so_mods=''):
    ...
    """
    tops = []
    mods = [salt, distro, jinja2, yaml, tornado, msgpack, certifi, singledispatch, concurrent, singledispatch_helpers, ssl_match_hostname, markupsafe, backports_abc]
